...
mysite/urls.py:这个是Django工程中的url声明文件,相当于Django开发的网站的目录的作用.[这里][5]你可以学到更多.
...
你可以去[这里][15]获取manage.py工具能够干什么的信息.

下面我们来看看Django框架给对应的对象生成了很丰富的交互操作API.

在当前的mysite的目录下键入以下命令:

<pre class="shell">python manage.py shell
</pre>
...
<p>
  ...
  # 现在我们就能够获取刚才保存的p的id,可能会返回’1L’,这个主要看你用的什么
</p>
...
保存刚才的修改,然后重新开发shell,<tt>python manage.py shell</tt>
