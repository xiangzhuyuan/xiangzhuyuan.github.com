...
author: mathewxiang
layout: post
permalink: /2011/12/how-to-write-a-jquery-plugin/
categories:
  - web前端
tags:
  - jQuery plugin
---
[http://docs.jquery.com/Plugins/Authoring][1]
...
<li class="toclevel-1">
  <a href="#Getting_Started"><span class="tocnumber">1</span> <span class="toctext">Getting Started</span></a>
</li>
<li class="toclevel-1">
  <a href="#Context"><span class="tocnumber">2</span> <span class="toctext">Context</span></a>
</li>
<li class="toclevel-1">
  <a href="#The_Basics"><span class="tocnumber">3</span> <span class="toctext">The Basics</span></a>
</li>
<li class="toclevel-1">
  <a href="#Maintaining_Chainability"><span class="tocnumber">4</span> <span class="toctext">Maintaining Chainability</span></a>
</li>
<li class="toclevel-1">
  <a href="#Defaults_and_Options"><span class="tocnumber">5</span> <span class="toctext">Defaults and Options</span></a>
</li>
<li class="toclevel-1">
  <a href="#Namespacing"><span class="tocnumber">6</span> <span class="toctext">Namespacing</span></a> <ul>
    <li class="toclevel-2">
      <a href="#Plugin_Methods"><span class="tocnumber">6.1</span> <span class="toctext">Plugin Methods</span></a>
    </li>
    <li class="toclevel-2">
      <a href="#Events"><span class="tocnumber">6.2</span> <span class="toctext">Events</span></a>
    </li>
    <li class="toclevel-2">
      <a href="#Data"><span class="tocnumber">6.3</span> <span class="toctext">Data</span></a>
    </li>
  </ul>
</li>

<li class="toclevel-1">
  <a href="#Summary_and_Best_Practices"><span class="tocnumber">7</span> <span class="toctext">Summary and Best Practice</span></a>
</li>
...
开发一个jQuery的插件,通过添加一个新的函数属性到**jQuery.fn.***对象*,而这个*对象名称*就是你创建的名字了:
...
但是等等,那个我喜欢的**$**符号呢? 别担心还在那里,只要确保你的插件不和别的库有冲突,那些库也有可能使用**$**付作为一种记号,<span style="text-decoration: underline;">给一个自运行的函数(闭包)传递jQuery对象的最好方式就是用$符号来代替他,这样在这个闭包中就不会被其他的库覆盖.</span>
...
这样就好多了,现在在这个闭包中,我们就能够尽情的**使用$符号来替代jQuery对象了**.

<a name="Context"></a>**上下文**:  
现在我们就能够在这个脚本中写属于自己的插件代码了.在开始之前,我要提到一个东西就是**context**.在一个临时的插件函数范围中<span style="text-decoration: underline;">,<strong>this</strong>关键字就指向到了jquery 插件触发的那个jquery对象.</span>在这里是一个插件替换,因为在很多其他的实例中当jQuery接受一个回调的时候,这个this关键字指向的是一个原生的DOM元素.这个经常会让程序员不必要的封装一下在jQuery的函数中.
...
<a name="Maintaining_Chainability"></a>**Maintaining Chainability**
...
因为插件返回的是**this关键字**在他的范围中,它维护了可连接性,能够让jQuery集合继续  
...
<a name="Defaults_and_Options"></a>**Defaults and Options**
...
<a name="#Summary_and_Best_Practices"></a>**总结和最佳实践:**  
...
*   jQuery.fn的发音应该是jQuery effin’
 ...
 [1]: http://docs.jquery.com/Plugins/Authoring "http://docs.jquery.com/Plugins/Authoring"