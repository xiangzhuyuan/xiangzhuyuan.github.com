...
<a href="http://www.yyxzy.org/wp-content/uploads/2011/09/1.png"><img class="alignnone size-medium wp-image-266" title="1" src="http://www.yyxzy.org/wp-content/uploads/2011/09/1-300x226.png" alt="" width="300" height="226" /></a>
2. 在哪里添加传统的jQuery调用
...
<a href="http://www.yyxzy.org/wp-content/uploads/2011/09/2.png"><img class="alignnone size-medium wp-image-267" title="2" src="http://www.yyxzy.org/wp-content/uploads/2011/09/2-300x221.png" alt="" width="300" height="221" /></a>
3. 立刻禁用所有的链接Ajax导航

Ajax的导航是相当的绚烂的,但是很多时候我们想把它禁用了.可以添加下面的代码来告诉mobile库来禁用ajax导航.在添加mobile库之后添加一小段代码,也就是说要在库加载完成之后才能够引用.
<a href="http://www.yyxzy.org/wp-content/uploads/2011/09/3.png"><img class="alignnone size-medium wp-image-268" title="3" src="http://www.yyxzy.org/wp-content/uploads/2011/09/3-300x134.png" alt="" width="300" height="134" /></a>
4. 禁止截取一些字符串
...
针对于list:
<pre><code>body .ui-li .ui-li-desc {</code></pre>
<pre><code> white-space: normal;</code></pre>
<pre><code> }</code></pre>
针对于尾部:
<pre><code>body .ui-footer .ui-title {</code></pre>
<pre><code> white-space: normal;</code></pre>
<pre><code> }</code></pre>
<pre><code> </code></pre>
5. 使用media属性来获取终端的类型
...
· “<a href="http://css-tricks.com/css-media-queries/"><strong>CSS Media Queries and Using Available Space</strong></a>,” CSS-Tricks;

· <a href="http://stuffandnonsense.co.uk/blog/about/hardboiled_css3_media_queries"><strong>Hardboiled CSS3 Media Queries</strong></a>,” Stuff and Nonsense.
